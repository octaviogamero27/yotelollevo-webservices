...
<head>
    ...
    <title>Danlí Market | Sistema Administrativo</title>
...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <a class="navbar-brand" href="/">Danlí Market</a>
            ...
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                        ...
                        <nav class="sb-sidenav-menu-nested nav"><a class="nav-link" href="/productos/index">Productos
                            <span class="badge badge-info">En Stock</span></a>
        ...
        <footer class="py-4 bg-light mt-auto">
            <div class="container-fluid">
                <div class="d-flex align-items-center justify-content-between small">
                    <div class="text-muted">Copyright &copy; Danlí Market {{date("yy") }}</div>
                    <div>
...
<script src="{{asset("https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.bundle.min.js")}}"
        crossorigin="anonymous"></script>
